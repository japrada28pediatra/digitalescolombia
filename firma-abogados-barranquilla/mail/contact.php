...
// Contact form handler for the Barranquilla site.
// Validates the incoming request, checks the required fields, and prepares
// a plain-text message so the team can review the inquiry quickly.
// The goal is to keep the flow simple: reject incomplete submissions early,
// preserve the sender's reply address, and return a clear success message.
...
$e_reply = "You can contact $name via email or via Phone $phone, $email";

// The message stays plain text on purpose so it can be read quickly
// in the inbox or forwarded without losing structure.
// This also keeps the script easy to debug if the form evolves later.
// Small maintenance notes like this are useful when someone revisits the file months later.
