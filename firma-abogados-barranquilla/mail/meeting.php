...
// Meeting booking handler for the Barranquilla firm.
// It receives a short case summary, validates the contact information,
// and prepares an email for the team so they can follow up with context.
// Keeping the script lightweight makes it easier to maintain over time.
...
$e_subject = 'Meeting Booking Form';
...
$e_body = "You have been contacted by $mname, their choosen Case type is $mcase" . PHP_EOL . PHP_EOL;
$e_reply = "You can contact $name via email or via Phone $mphone, $memail";

// A readable text body keeps the booking request easy to triage.
// That matters when the team needs to scan many incoming messages quickly.
// Keeping the output simple also makes future edits less error-prone.
// It is easier to maintain a clear text email than a pile of formatting tricks.
// That is especially handy for meeting requests, where a simple summary is enough.
